...
void Variation::setMutationRate(double mutationRate) {
    Variation::mutationRateSet = true;
    Variation::mutationRate = mutationRate;
}

void Variation::rotationToRight(Population& population) {
    if(!mutationRateSet) {
